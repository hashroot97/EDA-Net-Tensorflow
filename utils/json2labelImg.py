...
def json2labelImg(inJsonFolder,outImgFolder,encoding="ids"):
    num_files = 0
    for ele in os.listdir(inJsonFolder):
        num_files += 1
        print(num_files, '/', len(os.listdir(inJsonFolder)))
        inJson = inJsonFolder + ele
        outImg = outImgFolder + ele.split('_')[0] + '_leftImg8bit.png'
